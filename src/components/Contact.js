  ...
  return (
    <section id="contact" className="py-20 px-4 md:px-8 max-w-3xl mx-auto">
      ...
      <div className="text-center mb-12">
        <a href="tel:7812872715" className="inline-flex items-center gap-2 text-xl font-semibold text-cyan-400 hover:text-cyan-300 transition-colors">
      ...
      <div className="mt-12 flex justify-center gap-8 text-2xl">
        <a href="https://www.linkedin.com/in/thiruvelan-c30/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-200 hover:text-white transition-colors hover:-translate-y-1 transform duration-300">
        ...
        <a href="https://share.google/lhly9fT1m8ytfLBrd" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-200 hover:text-white transition-colors hover:-translate-y-1 transform duration-300">
        ...
        <a href="https://www.instagram.com/clever_boy_thiru/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-200 hover:text-white transition-colors hover:-translate-y-1 transform duration-300">
